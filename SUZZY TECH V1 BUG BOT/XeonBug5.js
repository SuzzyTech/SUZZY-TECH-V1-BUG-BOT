...
//YouTube: @suzzytech
//WhatsApp: +2348132342960
//want more free bot scripts? subscribe to my youtube channel: https://youtube.com/@suzzytech
...
await XeonBotInc.sendMessage(from, {text: xeonlod[i], edit: key });
        ...
        if (autobio) {
            XeonBotInc.updateProfileStatus(`24/7 Online Bot. *Youtube search- Suzzy Tech* user ${ownername}`).catch(_ => _)
        }
...
`.trim()
            ...
            case 'buyprem':
            case 'premium': {
                let teks = `Hi ${pushname}👋\nWant to Buy Premium? Just chat with the Suzzy Tech wa.me/2348132342960 😉`
                await XeonBotInc.sendMessage(m.chat, {
                    text: teks,
                    contextInfo: {
                        externalAdReply: {
            ...
            case 'repo':
                XeonBotInc.sendMessage(m.chat, {                  
		    youtube www.youtube.com/@suzzytech`,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
                            body: `SCRIPT OF ${botname} is on YouTube www.youtube.com/@suzzytech`,
                            thumbnailUrl: 'https://i.ibb.co/5hYWrRH/thumb.png',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
...
"sellerJid": "2348132342960@s.whatsapp.net",
...
break
            ...
            case 'help':
            case 'alive':
                let xeonmenuoh = `╭══ *❍ 𝗦𝗨𝗭𝗭𝗬_𝗧𝗘𝗖𝗛_𝗩𝟭-BUG_BOT ❍*
┃❁ *ᴏᴡɴᴇʀ:* Suzzy ○■□● ᴛᴇᴄʜ
┃❁ *ᴜᴘᴛɪᴍᴇ:* ${runtime(process.uptime())}
┃❁ *User:* ${pushname}
╰┈➤ ${xeonytimewisher} 😄  My bro
⚠️⚠️ ~Don't forget to subscribe~ 
*Suzzy Tech* ~Youtube Channel~ ⚠️⚠️
_Any help: yt link http://www.youtube.com/@SuzzyTech_
╰═════════════════⊷
╭═══❂ 𝗕𝗨𝗚 𝗠𝗘𝗡𝗨 ❂
┃ ❏ *xʀᴇᴀᴄᴛ <ʀᴇᴘʟʏ ᴄʜᴀᴛ>*
┃ ❏ *x <ɴᴜᴍʙᴇʀ|ᴀᴍᴏᴜɴᴛ>*
